...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private  TextView tv_exerises;
    private  TextView tv_myInfo;
    private ImageView iv_course;
    private  ImageView iv_execrises;
    ...
    private  void initBottomBar(){
        ...
        tv_exerises=(TextView)findViewById(R.id.bottom_bar_text_exercises);
        tv_myInfo=(TextView)findViewById(R.id.bottom_bar_text_myinfo);
        iv_course=(ImageView)findViewById(R.id.bottom_bar_image_course);
        iv_execrises=(ImageView)findViewById(R.id.bottom_bar_image_exercises);
    ...
    private  void clearBottomImageState(){
        ...
        tv_exerises.setTextColor(Color.parseColor("#666666"));
        tv_myInfo.setTextColor(Color.parseColor("#666666"));
        iv_course.setImageResource(R.drawable.main_course_icon);
        iv_execrises.setImageResource(R.drawable.main_exercises_icon);
    ...
    private void setSelectedStatus(int index){
        switch (index){
            ...
            case 1:
                ...
                iv_execrises.setImageResource(R.drawable.main_exercises_icon_selected);
                tv_exerises.setTextColor(Color.parseColor("#0097F7"));
                rl_title_bar.setVisibility(View.VISIBLE);
    ...
    protected long exitTime;//记录第一次点击是的时间
    @Override
