...
public class FindPswActivity extends AppCompatActivity {
    ...
    * */
    private  void init(){
        ...
        btn_validatel=(Button)findViewById(R.id.btn_validate);
        ...
        btn_validatel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
